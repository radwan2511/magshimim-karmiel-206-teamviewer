        ...
        private static void transferProc(object o)
        {
            ...
            while (queue.Running && queue.Index < queue.Length)
            {
                ...
                lock (file_buffer)
                {
                    ...
                    /*The reason the buffer size is 999999 is so it'll be about many kilobytes
                     * 4 Bytes = ID
                     * 8 Bytes = Index
                     * 4 Bytes = read
                     * 999999 Bytes = file_buffer
                     * 
                     */
                    ...
                    //Send our data
                    queue.Client.Send(Main.Encrypt(pw.GetBytes()));
